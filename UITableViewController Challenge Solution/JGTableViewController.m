...
//
//  Created by Justin Gazlay on 6/14/14.
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 2) {
        ...
        cell.textLabel.text = [NSString stringWithFormat:@"%@ %i", [self.data objectAtIndex:indexPath.section], indexPath.row];
    }
    else
    {
        
        cell.textLabel.text = [NSString stringWithFormat:@"%@", [self.data objectAtIndex:indexPath.section]];
    }
